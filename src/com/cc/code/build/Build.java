...
public class Build {
    ...
    public static void generator() throws Exception {
        // 得到数据源
        DataSourceConfig cfg = new DataSourceConfig("com.mysql.jdbc.Driver", "jdbc:mysql://123.57.155.6:3306/jzhaolin",
                "root", "test", DataSourceConfig.MYSQL);
         ...
         * 第三个参数:数据源配置
         */
        Generator generator = new Generator(new String[] { "task_subtask" }, "com.haolin", "com/cc/code/template/", cfg);
