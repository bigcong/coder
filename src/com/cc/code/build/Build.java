...
public class Build {
    ...
    public static void generator() throws Exception {
        // 得到数据源
        DataSourceConfig cfg = new DataSourceConfig("com.mysql.jdbc.Driver", "jdbc:mysql://localhost:3306/cc", "root",
         ...
         * 第三个参数:数据源配置
         */
        Generator generator = new Generator(new String[] { "" }, "com.cc", "com/cc/code/template/", cfg);
