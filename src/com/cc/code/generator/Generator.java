...
public class Generator {
    ...
    public void generate(boolean pojo, boolean controller, boolean mapper, boolean service, boolean serviceImpl,
            boolean sqlXml, boolean listJsp, boolean infoJsp, boolean viewJsp, boolean htmlList)
    ...
    throws Exception {
        ...
        for (Table table : tables) {
            ...
            if (htmlList) {
                buildFactory(table, configuration, FileWriterFactory.htmlList);
            }
        }
    ...
    public void buildFactory(Table table, Configuration configuration, int type) {
        ...
        case FileWriterFactory.VIEWJSP:
            ...
            break;
        case FileWriterFactory.htmlList:
            templateUrl = "listHtml.ftl";
            break;
        }
